...
_game.Title := "Remote Play with PlayStation®3"
_game.PID := ""
...
#HotIf _game.PID := WinExist(_game.Title) or print("[main(" Format_Msec(A_TickCount - _status._start_script) ")] Remote Play with PlayStation®3 not running")
